##############################################
## Gibbs sampler for the oracle model       ##
## Author: Hee Cheol Chung                  ##
## Data: 03/08/2020                         ##
##############################################

orclGibbs <- function(x, x.new, delta_mc, zhat_mc, R_mc, v0_mc, h, tau_mc, pijk,
...
SSSL <- SSVS(S, n, Sig = R_mc, V0, V1, tau_mc, lambda, pijk) # One Gibbs iteration

#BSUB -J R_tree              # sets the job name to R_tree.
...
#BSUB -R "rusage[mem=2000]"  # reserves ~2.0GB per process/CPU for the job (2.0GB * 10 Cores = 20GB per node)
#BSUB -M 2000                # sets to ~2GB the per process enforceable memory limit.
#BSUB -o tree.%J.o           # directs the job's standard output to stdout1.jobid

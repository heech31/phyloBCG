#BSUB -J R_QMP1              # sets the job name to R_fix.
...
#BSUB -R "rusage[mem=4000]"  # reserves ~4.0GB per process/CPU for the job (2.0GB * 4 Cores = 8GB per node)
#BSUB -M 4000                # sets to ~4GB the per process enforceable memory limit.
#BSUB -o qmp1.%J.o           # directs the job's standard output to stdout1.jobid

...
########################################################################
		...
		bt <- Sys.time()
		set.seed(77846,kind = "Mersenne-Twister" ,sample.kind = "Rejection" )
    ...
    saveRDS(gibbsSample,file=paste(resultPath,"result.QMPchain_4.rds",sep=""))
print(.Random.seed)

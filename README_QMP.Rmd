...
PhyloBCG implementation with QMP data ([Vandeputte et al., 2017](https://www.nature.com/articles/nature24460)).

Reference: Hee Cheol Chung, Irina Gaynanova and Yang Ni. [Phylogenetically informed Bayesian truncated copula graphical models for microbial association networks](https://arxiv.org/pdf/2105.05082.pdf). *arXiv*
...
### Summary of QMP data
```{r example, echo=TRUE,  warning=FALSE, message=FALSE, results='hide', fig.height=10, fig.width=14}
# Summary

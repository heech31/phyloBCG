...
## To run
To implement, (1) clone this repository; (2) open ```phyloBCG.Rproj```; (3) load packages and function located in ```./functions``` the folder as follows
...
This code will run 110 Gibbs iterations, then return a posterior sample of size 100 discarding the first 10 burn-in iterations. 
